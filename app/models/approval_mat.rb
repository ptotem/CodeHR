...
class ApprovalMat
  ...
  def send_notification
    ...
    self.approvers.each do |aa|
      ...
      unm.save
      utask=@approver.user.user_tasks.create title:"Approval Request" , description:"Please visit the url and approve", link:"/approval/#{self.ocls}/#{self.oid}/#{self._id}/#{self.process_tr_id}/#{self.step_no}",  type:"Approval", read: false
      utask.save
